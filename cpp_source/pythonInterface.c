...
{ optimizer32bit<gtype, oname>(g, p, state1, state2, beta1, beta2, eps, weight_decay, step, lr, is_sparse, gnorm_scale, n); } \
...
extern "C"
{
  ...
  void cdequantize_blockwise_fp32(float *code, unsigned char *A, float *absmax, float *out, const int n){ dequantizeBlockwise_fp32(code, A, absmax, out, n); }
	...
	{ name##32bit_g##gbits(g, p, state1, state2, beta1, beta2, eps, weight_decay, step, lr, is_sparse, gnorm_scale, n); } \

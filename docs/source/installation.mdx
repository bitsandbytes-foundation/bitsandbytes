...
We provide official support for NVIDIA GPUs, CPUs, Intel XPUs, Intel Gaudi, and Ascend NPU platforms. We also have experimental support for additional platforms such as AMD ROCm and Apple Silicon.

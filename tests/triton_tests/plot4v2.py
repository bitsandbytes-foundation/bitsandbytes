...
if __name__ == '__main__':
    ...
    ax.plot([0,1], sppedup_over_llmint8, color=cmap(0.5), linestyle=':', label='speedup over LLM.int8()', marker='^', markersize=8)
    ...
    plt.savefig('tests/triton_tests/plot4v2.pdf', bbox_inches='tight')

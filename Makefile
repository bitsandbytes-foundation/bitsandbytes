...
cuda113: $(BUILD_DIR) $(HOME)/anaconda3
	...
	nvcc $(COMPUTE_CAPABILITY) -Xcompiler '-fPIC' -dlink $(BUILD_DIR)/basicOps.o $(BUILD_DIR)/clusterKernels.o -o $(BUILD_DIR)/link.o 
	$(GPP) -std=c++11 -shared -fPIC -I $(CUDA_HOME)/include -I $(ROOT_DIR)/include -I $(ANACONDA_HOME)/include $(BUILD_DIR)/basicOps.o $(BUILD_DIR)/clusterKernels.o $(BUILD_DIR)/link.o $(FILES_CPP) -o ./bitsandbytes/libClusterNet.so $(LIB)
